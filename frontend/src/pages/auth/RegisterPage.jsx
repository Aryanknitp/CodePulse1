      ...
      <div className="flex gap-1">
        {[1, 2, 3, 4].map((i) => (
          <div
            ...
            style={{
              backgroundColor: i <= strength ? colors[strength] : "#1e2030",
            }}
          />
        ))}
      </div>
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#6b7280] mt-1">
            Start your personalized DSA journey
          </p>
        </div>
        ...
        <div className="bg-[#111218] border border-[#1e2030] rounded-xl p-6">
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            {serverError && (
              <div
                className="bg-[#ef4444]/10 border border-[#ef4444]/20 rounded-md px-3 py-2 text-xs text-[#ef4444]"
                role="alert"
              >
                {serverError}
              </div>
